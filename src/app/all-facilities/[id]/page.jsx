...
export default async function Page({ params }) {
  ...
  if (!res.ok) {
    return (
      <div className="text-red-500 min-h-screen bg-gray-950 flex items-center justify-center">
  ...
  if (!facilityData) {
    return (
      <div className="text-white min-h-screen bg-gray-950 flex items-center justify-center">
        Facility not found!
      </div>
    );
  }
